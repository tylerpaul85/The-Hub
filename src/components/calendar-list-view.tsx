      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <FilterSelect
          ...
          options={[
            ...
            ...profiles.map((p) => [p.id, profileLabel(p)] as [string, string]),
          ]}
        />
        <button
          type="button"
      ...
      {selected.size > 0 && (
        <div className="sticky top-0 z-20 flex flex-wrap items-center gap-2 bg-gold/10 border border-gold/40 rounded-md px-3 py-2">
          ...
          <div className="ml-auto flex flex-wrap gap-2">
            ...
            <Select
              onValueChange={(v) =>
                bulkUpdate.mutate({ created_by: v === "unassigned" ? null : v })
              }
            >
              <SelectTrigger className="h-8 w-[160px] text-xs">
                ...
                >
                  ...
                  <span
                    className={cn(
                      ...
                      dayIsToday ? "text-gold" : "text-foreground",
                    )}
                  >
                  ...
                  <div className="bg-background/40">
                    ...
                    {dayItems.map((it) => {
                      ...
                      const targetMissed =
                        ...
                        new Date(it.target_publish_date) < today &&
                        it.status !== "published";
                      return (
                        <DraggableRow
                          key={it.id}
                        ...
                        >
                          ...
                          <div className="flex items-center gap-1.5 min-w-0">
                            <span
                              className={cn(
                                ...
                                BRAND_STYLES[(it.brand ?? "PP") as Brand],
                              )}
                            >
                              {it.brand ?? "PP"}
                            </span>
                          ...
                          <Select
                            ...
                            onValueChange={(v) =>
                              updateField.mutate({
                                id: it.id,
                                patch: { created_by: v === "unassigned" ? null : v },
                              })
                            }
                          >
                            <SelectTrigger className="h-7 w-9 p-0 border-none bg-transparent hover:bg-muted/40 [&>svg]:hidden">
                              <div
                                className="h-7 w-7 rounded-full bg-muted flex items-center justify-center text-[10px] font-semibold"
                                title={profileLabel(owner)}
                              >
                                {owner ? (
                                  profileInitials(owner)
                                ) : (
                            ...
                            {it.platforms.slice(0, 3).map((p) => (
                              <span
                                ...
                                className={cn(
                                  ...
                                  PLATFORM_CHIP[p] ?? "border-border text-muted-foreground",
                                )}
                              >
                                {p}
                              </span>
                          ...
                          <span
                            ...
                            title={PRIORITY_LABEL[it.priority]}
                          >
                            <span
                              className={cn(
      ...
      <AlertDialog open={confirmDelete} onOpenChange={setConfirmDelete}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              This permanently removes the selected content items. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
