...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "application-name", content: "MSREG Hub" },
      { title: "MSREG Hub" },
      {
        name: "description",
        content: "Internal operations hub for Matt Smith Real Estate Group.",
      },
      { property: "og:title", content: "MSREG Hub" },
      { name: "twitter:title", content: "MSREG Hub" },
      {
