...
ALTER TABLE public.agent_signature_data 
  DROP CONSTRAINT IF EXISTS agent_signature_data_user_id_fkey,
  DROP CONSTRAINT IF EXISTS agent_signature_data_user_id_key,
  RENAME COLUMN user_id TO toolbox_agent_id;
...
ALTER TABLE public.signatures_push_log
  DROP CONSTRAINT IF EXISTS signatures_push_log_user_id_fkey,
  RENAME COLUMN user_id TO toolbox_agent_id;
